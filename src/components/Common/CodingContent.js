            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <p class="large text-muted">Here is a small program that will provide you with my github or linkedin page, please hit the run button to play!</p>
                        <iframe src="https://trinket.io/embed/python/2444963a5d" width="90%" height="300" frameborder="0" marginwidth="0" marginheight="0" allowfullscreen></iframe> 
                    </div>
                    <div class="col-lg-12 mx-auto text-center paddingTop">
                    <p class="large text-muted">During my course we had to create a small python game, we went with a different idea but this was my sample game!</p>
                        <iframe src="https://trinket.io/embed/python/2c408193a3?outputOnly=true&runOption=run" width="90%" height="300" frameborder="0" marginwidth="0" marginheight="0" allowfullscreen></iframe>
                    </div>    
                </div>
            </div>
            </section>
